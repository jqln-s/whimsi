...
export default {
    ...
    async execute(message) {
        ...
        const response = 'After long consideration of your application, we have decided to **reject** your application at this time. We appreicate you taking time to fill it out. You are welcome to submit a new application during the next round of applications.';
